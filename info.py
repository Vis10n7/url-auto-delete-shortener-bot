...
auth_channel = environ.get('AUTH_CHANNEL', '-1001744695766')
auth_grp = environ.get('AUTH_GROUP')
AUTH_CHANNEL = int(auth_channel) if auth_channel and id_pattern.search(auth_channel) else None
AUTH_GROUPS = [int(ch) for ch in auth_grp.split()] if auth_grp else None

# MongoDB information
DATABASE_URI = environ.get('DATABASE_URI', "mongosh "mongodb+srv://Nikhil_Vishwa7:nikhil_vishwa7@cluster0.dla9mvs.mongodb.net/?retryWrites=true&w=majority")
DATABASE_NAME = environ.get('DATABASE_NAME', "Cluster0")
COLLECTION_NAME = environ.get('COLLECTION_NAME', 'Telegram_files')

# Others
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1001519664150'))
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'visionmoviez')
...
FILE_STORE_CHANNEL = [int(ch) for ch in (environ.get('FILE_STORE_CHANNEL', '-1001885467323')).split()]
...
URL_SHORTNER_WEBSITE_API = environ.get('bf56e643ddbd84748b7567d820d8c51b44f0bca7', '')
...
CAPTION_BUTTON_URL = "https://youtube.com/@visionmoviez"
